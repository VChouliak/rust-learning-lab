...
use core::models::text::{Content, Statistics};
use core::traits::processor::DataProcessor;

pub struct TextAnalyzer;

impl DataProcessor<Statistics, &Content> for TextAnalyzer {
    fn process(&self, input: &Content) -> Result<Statistics, Box<dyn std::error::Error>> {
        ...
        Ok(Statistics {
            ...
            average_word_length: average_word_length as f64,
        })
    }
}
